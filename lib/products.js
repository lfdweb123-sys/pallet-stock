...
export const CATEGORIES = [
  ...
  { slug: 'barbecue', label: { it: 'Barbecue', fr: 'Barbecues', en: 'Barbecues' }, icon: '🍖' },
];
...
export const PRODUCTS = [
  ...
  // ── SMARTPHONE ──────────────────────────────
  {
    ...
    oldPrice: 729,
    stock: 18,
    image: '/images/products/iPhone 15 128GB.jpg',
    rating: 4.7,
    reviewsCount: 1842,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 1049,
    stock: 11,
    image: '/images/products/iphone-15-pro-256.webp',
    rating: 4.8,
    reviewsCount: 967,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 499,
    stock: 13,
    image: '/images/products/111866_sp867-iphone-se-3gen.png',
    rating: 4.5,
    reviewsCount: 754,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 729,
    stock: 10,
    image: '/images/products/in-galaxy-s24-492654-492654-sm-s921bzvbins-541169481.png',
    rating: 4.6,
    reviewsCount: 1320,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 249,
    stock: 17,
    image: '/images/products/africa-fr-galaxy-buds3-pro-r630-sm-r630nzaamea-542133520.webp',
    rating: 4.6,
    reviewsCount: 1980,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 279,
    stock: 14,
    image: '/images/products/111853_apple-watch-se-2nd-gen.png',
    rating: 4.7,
    reviewsCount: 2110,
    reviewsList: [
  ...
  // ── BARBECUE ────────────────────────────────
    {
      slug: 'campingaz-4-series-classic-ls-plus',
      sku: 'LOT-BBQ-01',
      category: 'barbecue',
      brand: 'Campingaz',
      name: 'Campingaz 4 Series Classic LS Plus – Barbecue a Gas',
      price: 449,
      oldPrice: 549,
      stock: 6,
      image: '/images/products/81PNBCbs1CL._AC_SX679_.jpg',
      rating: 4.7,
      reviewsCount: 1860,
      reviewsList: [
        { stars: 5, text: { it: 'Cuoce in modo uniforme su tutta la griglia, il fornello laterale è perfetto per le salse di accompagnamento.', fr: 'Cuit de façon uniforme sur toute la grille, le réchaud latéral est parfait pour les sauces d\'accompagnement.', en: 'Cooks evenly across the whole grill, the side burner is perfect for sauces on the side.' } },
        { stars: 5, text: { it: 'Montaggio semplice, struttura robusta su ruote facile da spostare in giardino.', fr: 'Montage simple, structure robuste sur roulettes facile à déplacer dans le jardin.', en: 'Easy to assemble, sturdy structure on wheels that\'s easy to move around the garden.' } }
      ],
      description: {
        it: 'Barbecue a gas Campingaz 4 Series Classic LS Plus, 4 fuochi principali + fornello laterale, piastra di cottura InstaClean, mobile con ante e ruote per spostamento facile.',
        fr: 'Barbecue à gaz Campingaz 4 Series Classic LS Plus, 4 brûleurs principaux + réchaud latéral, plaque de cuisson InstaClean, meuble avec portes et roulettes pour faciliter le déplacement.',
        en: 'Campingaz 4 Series Classic LS Plus gas barbecue, 4 main burners + side burner, InstaClean cooking plate, cabinet with doors and wheels for easy moving.'
      }
    },
  {
    ...
    oldPrice: 319,
    stock: 9,
    image: '/images/products/global-wearable-Galaxy_Watch7_Product_Group_Image_944x510_PC-550002042.webp',
    rating: 4.6,
    reviewsCount: 870,
    reviewsList: [
  ...
  // ── TABLET ──────────────────────────────────
  {
    ...
    oldPrice: 449,
    stock: 20,
    image: '/images/products/ipad-model-unselect-gallery-1-202503_GEO_EMEA.webp',
    rating: 4.7,
    reviewsCount: 1640,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 719,
    stock: 9,
    image: '/images/products/ipad-air-model-unselect-gallery-1-202405.webp',
    rating: 4.8,
    reviewsCount: 540,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 2199,
    stock: 4,
    image: '/images/products/refurb-mbp14-m3-max-pro-spaceblack-202402.webp',
    rating: 4.9,
    reviewsCount: 312,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 1599,
    stock: 6,
    image: '/images/products/dell.webp',
    rating: 4.5,
    reviewsCount: 421,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 1799,
    stock: 5,
    image: '/images/products/product_1712041094076d7028f4e219134fc80b6947af83cb.webp',
    rating: 4.6,
    reviewsCount: 198,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 729,
    stock: 12,
    image: '/images/products/con-strelka-22c1-hp-pavilion-15-eg2000-product-image.png',
    rating: 4.4,
    reviewsCount: 860,
    reviewsList: [
  ...
  // ── DRONE ───────────────────────────────────
  {
    ...
    oldPrice: 899,
    stock: 7,
    image: '/images/products/6f8ef1cb760b78a3a2226ff57b608c2d@origin.jpg',
    rating: 4.8,
    reviewsCount: 430,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 249,
    stock: 13,
    image: '/images/products/6bbc68b70e6d10968641036f6f831af0@ultra.webp',
    rating: 4.5,
    reviewsCount: 612,
    reviewsList: [
  ...
  // ── MOBILITÀ ELETTRICA (vélos / trottinettes) ─
  {
    ...
    oldPrice: 1099,
    stock: 6,
    image: '/images/products/5631_98769186-17f4-4857-8f62-43c359e34a330-1.jpg',
    rating: 4.5,
    reviewsCount: 214,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 549,
    stock: 11,
    image: '/images/products/pms_1661321967.02267825.webp',
    rating: 4.6,
    reviewsCount: 980,
    reviewsList: [
  ...
  // ── FRIGO ───────────────────────────────────
  {
    ...
    oldPrice: 599,
    stock: 7,
    image: '/images/products/RB50DG602ES9EF_PC.webp',
    rating: 4.6,
    reviewsCount: 540,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 1199,
    stock: 3,
    image: '/images/products/182811-1600-auto.webp',
    rating: 4.7,
    reviewsCount: 188,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 189,
    stock: 15,
    image: '/images/products/20546096_KGN86VIEA_STP_def.webp',
    rating: 4.4,
    reviewsCount: 760,
    reviewsList: [
  ...
  // ── CLIMATIZZATORI ───────────────────────────
  {
    ...
    oldPrice: 489,
    stock: 14,
    image: '/images/products/88503.webp',
    rating: 4.4,
    reviewsCount: 920,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 329,
    stock: 19,
    image: '/images/products/51tOArQ-05L._AC_SY445_SX342_QL70_ML2_.jpg',
    rating: 4.2,
    reviewsCount: 540,
    reviewsList: [
  ...
  // ── RISCALDAMENTO ───────────────────────────
  {
    ...
    oldPrice: 119,
    stock: 25,
    image: '/images/products/71qzhuJD6lL._AC_SY741_.jpg',
    rating: 4.5,
    reviewsCount: 1340,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 59,
    stock: 30,
    image: '/images/products/Termoventilatore ceramico 2200W con timer.jpg',
    rating: 4.3,
    reviewsCount: 1880,
    reviewsList: [
  ...
  // ── PELLET E LEGNA ───────────────────────────
  {
    ...
    oldPrice: 8.5,
    stock: 240,
    image: '/images/products/91ms1iqH+FL._AC_SY300_SX300_QL70_ML2_.jpg',
    rating: 4.7,
    reviewsCount: 3100,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 199,
    stock: 35,
    image: '/images/products/61Y5WM2egrL._AC_UL320_.jpg',
    rating: 4.6,
    reviewsCount: 740,
    reviewsList: [
  ...
  // ── ASPIRAPOLVERE ───────────────────────────
  {
    ...
    oldPrice: 699,
    stock: 9,
    image: '/images/products/446986-01.webp',
    rating: 4.7,
    reviewsCount: 2640,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 399,
    stock: 11,
    image: '/images/products/S8ecf92feeadc4eb1846268191c1ddefca.jpg_960x960q75.jpg',
    rating: 4.5,
    reviewsCount: 1290,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 109,
    stock: 22,
    image: '/images/products/71tvqtbNkvL._AC_UL320_.jpg',
    rating: 4.3,
    reviewsCount: 960,
    reviewsList: [
  ...
  // ── CUCINA ──────────────────────────────────
  {
    ...
    oldPrice: 429,
    stock: 16,
    image: '/images/products/81YR2ubSOxL._AC_SX679_.jpg',
    rating: 4.6,
    reviewsCount: 1480,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 259,
    stock: 20,
    image: '/images/products/51+9BfZ2tBL._AC_SY300_SX300_QL70_ML2_.jpg',
    rating: 4.7,
    reviewsCount: 2210,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 319,
    stock: 9,
    image: '/images/products/Kenwood Robot da Cucina Multifunzione 1000W.webp',
    rating: 4.5,
    reviewsCount: 670,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 159,
    stock: 17,
    image: '/images/products/Tognana Batteria di Pentole Antiaderenti 10 Pezzi.jpg',
    rating: 4.4,
    reviewsCount: 530,
    reviewsList: [
  ...
  // ── FORNO ───────────────────────────────────
  {
    ...
    oldPrice: 459,
    stock: 8,
    image: '/images/products/710ccHatHcL._AC_SX342_SY445_QL70_ML2_.jpg',
    rating: 4.6,
    reviewsCount: 410,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 149,
    stock: 16,
    image: '/images/products/it-microwave-oven-convection-mc28h5015as-mc28h5015as-et-001-front-silver.webp',
    rating: 4.4,
    reviewsCount: 690,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 139,
    stock: 14,
    image: '/images/products/41F6TVp1rOS._AC_SY300_SX300_QL70_ML2_.jpg',
    rating: 4.3,
    reviewsCount: 350,
    reviewsList: [
  ...
  // ── CASA E GIARDINO ───────────────────────────
  {
    ...
    oldPrice: 79,
    stock: 33,
    image: '/images/products/61LflSvDBFL._AC_UL320_.jpg',
    rating: 4.5,
    reviewsCount: 480,
    reviewsList: [
      { stars: 5, text: { it: 'Luce calda e regolabile perfetta per le serate sul divano, telecomando comodo dal letto.', fr: 'Lumière chaude et réglable parfaite pour les soirées canapé, télécommande pratique depuis le lit.', en: 'Warm, adjustable light perfect for cozy evenings, remote is handy from the bed.' } },
      { stars: 4, text: { it: 'Design elegante, base un po\' leggera quindi va posizionata lontano dal passaggio.', fr: 'Design élégant, base un peu légère donc à placer loin du passage.', en: 'Elegant design, base is a bit light so position it away from foot traffic.' } }
    ],
    description: {
  ...
  },
  {
    ...
    oldPrice: 65,
    stock: 28,
    image: '/images/products/71tbS2k+EVL._AC_SY300_SX300_QL70_ML2_.jpg',
    rating: 4.4,
    reviewsCount: 320,
    reviewsList: [
      { stars: 4, text: { it: 'Set completo per il rinvaso, la borsa rende tutto facile da trasportare in balcone o giardino.', fr: 'Set complet pour le rempotage, le sac rend tout facile à transporter sur le balcon ou au jardin.', en: 'Complete set for repotting, the bag makes everything easy to carry to the balcony or garden.' } },
      { stars: 4, text: { it: 'Buona qualità per uso occasionale, i guanti incluso sono un\'aggiunta gradita.', fr: 'Bonne qualité pour un usage occasionnel, les gants inclus sont un plus appréciable.', en: 'Good quality for occasional use, the included gloves are a nice touch.' } }
    ],
    description: {
  ...
  },
  {
    ...
    oldPrice: 219,
    stock: 8,
    image: '/images/products/610DPEQcILL._AC_UL320_.jpg',
    rating: 4.3,
    reviewsCount: 210,
    reviewsList: [
      { stars: 4, text: { it: 'Bel design moderno, montaggio richiede circa un\'ora ma le istruzioni sono chiare.', fr: 'Beau design moderne, montage demande environ une heure mais les instructions sont claires.', en: 'Nice modern design, assembly takes about an hour but instructions are clear.' } },
      { stars: 4, text: { it: 'Ottimo rapporto qualità prezzo, le ante chiudono bene e nascondono i cavi.', fr: 'Excellent rapport qualité-prix, les portes ferment bien et cachent les câbles.', en: 'Great value, the doors close nicely and hide the cables well.' } }
    ],
    description: {
  ...
  // ── OCCHIALI DA SOLE ──────────────────────────
  {
    ...
    oldPrice: 45,
    stock: 60,
    image: '/images/products/61q2zDktqCL._AC_UL320_.jpg',
    rating: 4.5,
    reviewsCount: 870,
    reviewsList: [
      { stars: 5, text: { it: 'Lenti polarizzate davvero efficaci, niente più riflessi guidando contro sole.', fr: 'Verres polarisés vraiment efficaces, plus de reflets en conduisant face au soleil.', en: 'Polarized lenses really work, no more glare when driving into the sun.' } },
      { stars: 4, text: { it: 'Bel design classico, la montatura è leggera ma sembra solida nell\'uso quotidiano.', fr: 'Beau design classique, la monture est légère mais semble solide à l\'usage quotidien.', en: 'Nice classic design, the frame is light but feels sturdy in daily use.' } }
    ],
    description: {
  ...
  },
  {
    ...
    oldPrice: 39,
    stock: 75,
    image: '/images/products/Occhiali da Sole Sportivi TR90 Antiscivolo.jpg',
    rating: 4.3,
    reviewsCount: 540,
    reviewsList: [
      { stars: 4, text: { it: 'Perfetti per correre, non scivolano nemmeno sudando molto.', fr: 'Parfaites pour courir, ne glissent pas même en transpirant beaucoup.', en: 'Perfect for running, they don\'t slip even when sweating a lot.' } },
      { stars: 4, text: { it: 'Leggerissimi e flessibili, ottimi per ciclismo e attività outdoor in genere.', fr: 'Très légères et flexibles, idéales pour le cyclisme et les activités outdoor en général.', en: 'Very light and flexible, great for cycling and outdoor activities in general.' } }
    ],
    description: {
  ...
  // ── ANIMALI DOMESTICI ─────────────────────────
  {
    ...
    oldPrice: 49,
    stock: 45,
    image: '/images/products/Crocchette per Cane Adulto Pollo e Riso – Sacco 12kg.webp',
    rating: 4.6,
    reviewsCount: 1120,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 36,
    stock: 50,
    image: '/images/products/product_list.webp',
    rating: 4.5,
    reviewsCount: 980,
    reviewsList: [
  ...
  },
  {
    ...
    oldPrice: 19,
    stock: 70,
    image: '/images/products/61sz2CU6DzL._AC_SY300_SX300_QL70_ML2_.jpg',
    rating: 4.4,
    reviewsCount: 640,
    reviewsList: [
      ...
      { stars: 4, text: { it: 'Poca polvere quando la verso, il mio gatto l\'ha accettata senza problemi.', fr: 'Peu de poussière en versant, mon chat l\'a acceptée sans problème.', en: 'Low dust when pouring, my cat accepted it without any issue.' } }
    ],
    description: {
  ...
  },
  {
    ...
    oldPrice: 89,
    stock: 24,
    image: '/images/products/71FgnxRXgHL._AC_UL320_.jpg',
    rating: 4.5,
    reviewsCount: 410,
    reviewsList: [
      { stars: 5, text: { it: 'I miei due gatti lo usano tutto il giorno, struttura stabile e robusta nonostante l\'altezza.', fr: 'Mes deux chats l\'utilisent toute la journée, structure stable et robuste malgré la hauteur.', en: 'My two cats use it all day, stable and sturdy despite the height.' } },
      { stars: 4, text: { it: 'Bel design che si integra in salotto, montaggio un po\' lungo ma manuale chiaro.', fr: 'Beau design qui s\'intègre au salon, montage un peu long mais manuel clair.', en: 'Nice design that blends into the living room, assembly takes a while but the manual is clear.' } }
    ],
    description: {
      it: 'Tiragraffi albero per gatti alto 150cm, con tana, piattaforme multiple e corda sisal per le unghie.',
      fr: 'Arbre à chat de 150cm de haut, avec niche, plateformes multiples et corde en sisal pour les griffes.',
      en: '150cm tall cat tree, with den, multiple platforms and sisal rope for scratching.'
    }
  },
  {
    ...
    oldPrice: 32,
    stock: 38,
    image: '/images/products/71l0rQF7pqL._AC_SX679_.jpg',
    rating: 4.4,
    reviewsCount: 290,
    reviewsList: [
      { stars: 4, text: { it: 'Il mio cucciolo si diverte molto, materiali resistenti ai morsi più forti.', fr: 'Mon chiot s\'amuse beaucoup, matériaux résistants aux morsures les plus fortes.', en: 'My puppy has a blast, materials hold up to the strongest bites.' } },
      { stars: 4, text: { it: 'Ottimo set vario, il dispenser di croccantini lo tiene impegnato per ore.', fr: 'Excellent set varié, le distributeur de croquettes le tient occupé pendant des heures.', en: 'Great varied set, the treat dispenser keeps him busy for hours.' } }
    ],
    description: {
      it: 'Set di 5 giochi interattivi per cane: corde, palline e dispenser di croccantini, materiali atossici.',
      fr: 'Set de 5 jouets interactifs pour chien : cordes, balles et distributeur de croquettes, matériaux non toxiques.',
      en: '5-piece interactive dog toy set: ropes, balls and treat dispenser, non-toxic materials.'
    }
  },

  // ── FAI DA TE E UTENSILI (provenienti da lotti Jobalots) ──
  {
    ...
    oldPrice: 35,
    stock: 47,
    image: 'https://assets.jobalots.com/product_image/m9a9minItaPCSQdh5c4pwO8H6Nj6PAIngXpxdTl9.png?format=auto&width=1080&quality=100',
    rating: 4.5,
    reviewsCount: 96,
    reviewsList: [
      { stars: 5, text: { it: 'Sottilissimo, entra comodo nella tasca dei jeans senza fare rigonfiamento.', fr: 'Très fin, rentre facilement dans la poche du jean sans faire de bosse.', en: 'Super slim, fits comfortably in a jeans pocket without bulging.' } },
      { stars: 4, text: { it: 'Pelle di buona fattura per il prezzo, contiene quanto serve per uso quotidiano.', fr: 'Cuir de bonne facture pour le prix, contient ce qu\'il faut pour un usage quotidien.', en: 'Good quality leather for the price, holds what you need for daily use.' } }
    ],
    description: {
      it: 'Porta-carte sottile in pelle marrone, taglia unica, design minimalista per portafoglio quotidiano.',
      fr: 'Porte-cartes fin en cuir marron, taille unique, design minimaliste pour un portefeuille du quotidien.',
      en: 'Slim brown leather card holder, one size, minimalist design for everyday carry.'
    }
  },
  {
    ...
    oldPrice: 38,
    stock: 12,
    image: 'https://assets.jobalots.com/product_image/4LBTKhjRdqmZPI6BHxGPJnjod9RVH4gwlWGZ60lD.png?format=auto&width=1080&quality=100',
    rating: 4.6,
    reviewsCount: 540,
    reviewsList: [
      { stars: 5, text: { it: 'Cricchetto fluido e preciso, perfette per riparazioni in spazi ristretti dell\'auto.', fr: 'Cliquet fluide et précis, parfaites pour les réparations dans les espaces restreints de la voiture.', en: 'Smooth, precise ratchet action, perfect for repairs in tight spots on the car.' } },
      { stars: 4, text: { it: 'Set completo per il fai da te, la borsa a rotolo organizza bene tutte le misure.', fr: 'Set complet pour le bricolage, le sac à enrouler organise bien toutes les tailles.', en: 'Complete DIY set, the roll-up pouch organizes all the sizes nicely.' } }
    ],
    description: {
      it: 'Set 12 chiavi a cricchetto ENEACRO, misure 6-19mm, acciaio Cr-V, 72 denti, borsa a rotolo incluso.',
      fr: 'Set de 12 clés à cliquet ENEACRO, tailles 6-19mm, acier Cr-V, 72 dents, sac à enrouler inclus.',
      en: 'ENEACRO 12-piece ratcheting wrench set, 6-19mm sizes, Cr-V steel, 72-tooth, roll-up pouch included.'
    }
  },
  {
    slug: 'materassi-gonfiabili-campeggio-lotto',
    sku: 'JBL-YELLOW32474',
    category: 'casa-giardino',
    brand: 'Jobalots',
    name: 'Lotto Materassi Auto-Gonfiabili da Campeggio – Letti Singoli e Doppi',
    price: 89,
    oldPrice: 149,
    stock: 21,
    image: 'https://assets.jobalots.com/product_image/sQ70d5u17S7RmsI2ZtoYn4MpybNVS7T5gatyACtD.png?format=auto&width=1080&quality=100',
    rating: 4.3,
    reviewsCount: 58,
    reviewsList: [
      { stars: 4, text: { it: 'Ottimi per ospiti improvvisi, si gonfiano da soli in pochi minuti senza pompa.', fr: 'Parfaits pour les invités imprévus, se gonflent seuls en quelques minutes sans pompe.', en: 'Great for unexpected guests, self-inflate in minutes with no pump needed.' } },
      { stars: 4, text: { it: 'Comodi per il campeggio, alcuni del lotto leggermente più morbidi di altri ma tutti funzionanti.', fr: 'Confortables pour le camping, certains du lot un peu plus souples que d\'autres mais tous fonctionnels.', en: 'Comfortable for camping, some in the lot are slightly softer than others but all work fine.' } }
    ],
    description: {
      it: 'Lotto di materassi gonfiabili da campeggio, materassi auto-gonfianti per letti singoli e doppi, ideali per ospiti e attività outdoor.',
      fr: 'Lot de matelas gonflables de camping, matelas auto-gonflants pour lits simples et doubles, idéaux pour invités et activités outdoor.',
      en: 'Camping air mattress lot, self-inflating mattresses for single and double beds, ideal for guests and outdoor use.'
    }
  },
  {
    slug: 'aspirapiscina-wireless-ipx8',
    sku: 'JBL-LPNWE402798752',
    category: 'casa-giardino',
    brand: 'Jobalots',
    name: 'Aspirapolvere per Piscina Wireless 5000mAh Doppio Motore IPX8',
    price: 79,
    oldPrice: 129,
    stock: 1,
    image: 'https://assets.jobalots.com/product_image/mPPeDUKUeuTWVK9CwzU8JgnzdfuVDur6G4N69Sop.png?format=auto&width=1080&quality=100',
    rating: 4.2,
    reviewsCount: 73,
    reviewsList: [
      { stars: 4, text: { it: 'Pulisce bene il fondo della piscina fuori terra, doppio motore davvero potente.', fr: 'Nettoie bien le fond de la piscine hors-sol, double moteur vraiment puissant.', en: 'Cleans the bottom of the above-ground pool well, the dual motor is genuinely powerful.' } },
      { stars: 4, text: { it: 'Senza fili comodissimo, l\'autonomia basta per una piscina di medie dimensioni.', fr: 'Sans fil très pratique, l\'autonomie suffit pour une piscine de taille moyenne.', en: 'Cordless and very convenient, battery life is enough for a medium-sized pool.' } }
    ],
    description: {
      it: 'Aspirapolvere per piscina senza fili, batteria 5000mAh, doppio motore, certificazione IPX8 impermeabile.',
      fr: 'Aspirateur de piscine sans fil, batterie 5000mAh, double moteur, certification IPX8 étanche.',
      en: 'Cordless pool vacuum cleaner, 5000mAh battery, dual motor, IPX8 waterproof rating.'
    }
  },
  {
    slug: 'set-inserti-avvitatore-dewalt-flextorq-40pz',
    sku: 'JBL-LPNRP073575739',
    category: 'fai-da-te',
    brand: 'DEWALT',
    name: 'Set Inserti FlexTorq DEWALT per Avvitatore a Impulsi 40 Pezzi',
    price: 22,
    oldPrice: 32,
    stock: 1,
    image: 'https://assets.jobalots.com/product_image/GxXasAlw4t09yekQFJnQYabyCJnXl59b1hMmbMmq.png?format=auto&width=1080&quality=100',
    rating: 4.7,
    reviewsCount: 210,
    reviewsList: [
      { stars: 5, text: { it: 'Inserti DEWALT veramente resistenti, non si consumano nemmeno dopo molti utilizzi intensivi.', fr: 'Embouts DEWALT vraiment résistants, ne s\'usent pas même après de nombreuses utilisations intensives.', en: 'Genuinely tough DEWALT bits, they don\'t wear out even after heavy repeated use.' } },
      { stars: 5, text: { it: 'Set completissimo per qualsiasi lavoro in casa, custodia robusta e organizzata.', fr: 'Set très complet pour tous travaux à la maison, étui robuste et bien organisé.', en: 'Very complete set for any home job, sturdy and well-organized case.' } }
    ],
    description: {
      it: 'Set 40 pezzi inserti FlexTorq DEWALT per avvitatore a impulsi (DWA2T40IR), massima durata e precisione.',
      fr: 'Set de 40 embouts FlexTorq DEWALT pour visseuse à percussion (DWA2T40IR), durabilité et précision maximales.',
      en: 'DEWALT FlexTorq 40-piece impact screwdriver bit set (DWA2T40IR), maximum durability and precision.'
    }
  },
  {
    slug: 'cassetta-attrezzi-deko-trapano-12v',
    sku: 'JBL-spLkQfkK4wz',
    category: 'fai-da-te',
    brand: 'DEKO',
    name: 'Cassetta Attrezzi DEKO con Trapano Senza Fili 12V e Set 12 Utensili',
    price: 49,
    oldPrice: 79,
    stock: 1,
    image: 'https://assets.jobalots.com/product_image/2Gb858gyBskLzxdbkLbiSgh5amCfmjNMDQqQinoU.png?format=auto&width=1080&quality=100',
    rating: 4.5,
    reviewsCount: 380,
    reviewsList: [
      { stars: 5, text: { it: 'Regalo perfetto per chi inizia col fai da te, trapano leggero ma con buona coppia.', fr: 'Cadeau parfait pour qui débute en bricolage, perceuse légère mais avec un bon couple.', en: 'Perfect gift for someone starting out with DIY, the drill is light but has good torque.' } },
      { stars: 4, text: { it: 'Cassetta ben organizzata con tutto il necessario per piccole riparazioni in casa.', fr: 'Boîte bien organisée avec tout le nécessaire pour les petites réparations à la maison.', en: 'Well-organized case with everything needed for small home repairs.' } }
    ],
    description: {
      it: 'Cassetta attrezzi DEKO per la casa con trapano avvitatore senza fili 12V e set di 12 utensili manuali, valigetta di trasporto incluso.',
      fr: 'Boîte à outils DEKO pour la maison avec perceuse-visseuse sans fil 12V et set de 12 outils à main, valise de transport incluse.',
      en: 'DEKO home toolbox with 12V cordless drill/driver and 12-piece hand tool set, carrying case included.'
    }
  }
];
